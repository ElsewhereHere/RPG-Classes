...
export function DivineAscension(player) {
  ...
  player.playAnimation("animation.paragonia_classes.player.divine_ascension_start");
  ...
  mc.system.runTimeout(() => {
    ...
    player.playAnimation("animation.paragonia_classes.player.divine_ascension_crash");
